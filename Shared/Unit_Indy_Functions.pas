...
/// Function for transfer of Bytes Arrays via INDY 10 TCP IP Servers
/// </summary>
function SendBuffer(AClient: TIdTCPClient; ABuffer: TIdBytes): Boolean; overload;
...
/// Byte Array
/// </param>
function ByteArrayToMyRecord(ABuffer: TIdBytes): TMyRecord;
...
/// adjust this record definition to your needs
/// </param>
function MyRecordToByteArray(aRecord: TMyRecord): TIdBytes;
